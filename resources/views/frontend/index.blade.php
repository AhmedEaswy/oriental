  ...
  >
    <div class=" z-10 relative">
      <div class="text-center">
        ...
        <p class="mt-4 text-xl text-gray-700">{{ setting('description', 'You can fill this form, and we will call you back ASAP', 'string', 'about_us', '*') }}</p>
      </div>
      <div class="grid sm:grid-cols-2 grid-cols-1 mt-9">
        <div class="">
          <div class="flex justify-center">
            <img src="{{ setting('logo', asset('assets/frontend/image/logo.png'), 'file', 'about_us', '*') }}" alt="logo" width="187" height="202">
          </div>
          <ul class="list-none m-0 px-9 flex gap-4 flex-col justify-center w-80 mx-auto">
            <li class="flex flex-row items-center gap-2">
              ...
              <div>
                <div class="font-semibold text-xl">{{ setting('phone_1', '+201000000', 'string', 'contact', '*') }}</div>
                <div class="font-semibold text-xl">{{ setting('phone_2', '+201000000', 'string', 'contact', '*') }}</div>
              </div>
            </li>
            <li class="flex flex-row items-center gap-2">
              ...
              <div>
                <div class="font-semibold text-xl">{{ setting('whatsapp', '+201000000', 'string', 'contact', '*') }}</div>
              </div>
            </li>
            <li class="flex flex-row items-center gap-2">
              ...
              <div>
                <div class="font-semibold text-xl">{{ setting('email', 'info@oriental-eg.com', 'string', 'contact', '*') }}</div>
              </div>
            </li>
          </ul>
          ...
          <form action="{{ route('contactStore') }}" class="flex flex-col gap-5" method="POST">
            ...
            <div class="w-96 mx-auto">
              <input type="text" placeholder="Name"
                     ...
                     class="border-b-black border-x-0 border-t-0 border-b-2 px-0 py-3 text-lg
                                       text-gray-700 w-full font-semibold bg-transparent focus:border-b-amber-200 focus:ring-transparent focus:outline-none">
              @error('name') <small class="text-red-700 text-sm">{{ $message }}</small> @enderror

            </div>
            <div class="w-96 mx-auto">
              <label for="phone_code" class="text-lg text-gray-700">Phone Number</label>
              <div class="flex flex-row">
                ...
                <input type="text"
                       ...
                       required
                       class="border-b-black border-x-0 border-t-0 border-b-2 px-0 py-3 text-lg
                                       text-gray-700 w-80 font-semibold bg-transparent focus:border-b-amber-200 focus:ring-transparent focus:outline-none">
            ...
            <div class="w-96 mx-auto">
              <input type="email" placeholder="Email"
                     name="email"
                     required
                     class="border-b-black border-x-0 border-t-0 border-b-2 px-0 py-3
                               text-lg w-full
                               text-gray-700 font-semibold bg-transparent focus:border-b-amber-200 focus:ring-transparent">
              @error('email') <small class="text-red-700 text-sm">{{ $message }}</small> @enderror

            </div>
            <div class="w-96 mx-auto">
              <label for="interest" class="text-lg text-gray-700">Interested in</label>
              <select name="interest"
                      id="interest"
                      class="border-black border-2 px-1 py-0 text-lg w-full mt-4
            ...
            <div class="w-96 mx-auto">
              <label for="message" class="text-lg text-gray-700">Message</label>
              <textarea id="message" name="content" rows="4" class="mt-1 block w-full bg-transparent border-black border-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm
                            focus:ring-amber-300 focus:border-amber-300"
              ></textarea>
              @error('message') <small class="text-red-700 text-sm">{{ $message }}</small> @enderror

            </div>
            <div class="w-96 mx-auto flex justify-center">
      ...
      <div class="grid sm:grid-cols-5 grid-cols-1">
        <div class="sm:col-span-2">
          ...
          <ul class="list-none flex gap-4 flex-col justify-center mt-5">
            <li class="flex flex-row items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telephon mc-fill" viewBox="0 0 16 16">
                <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z"/>
              </svg>
              <div>
                <a href="#" class="font-semibold text-lg text-white">
            ...
            <li class="flex flex-row items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-whatsapp mc-fill" viewBox="0 0 16 16">
                <path d="M13.601 2.326A7.854 7.854 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.933 7.933 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.898 7.898 0 0 0 13.6 2.326zM7.994 14.521a6.573 6.573 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.557 6.557 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592zm3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.729.729 0 0 0-.529.247c-.182.198-.691.677-.691 1.654 0 .977.71 1.916.81 2.049.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232z"/>
              </svg>
              <div>
                <a href="#" class="font-semibold text-lg text-white">{{ setting('whatsapp', '+201000000', 'string', 'contact', '*') }}</a>
              </div>
            </li>
            <li class="flex flex-row items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-envelope mc-fill" viewBox="0 0 16 16">
                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
              </svg>
              <div>
                <a href="#" class="font-semibold text-lg text-white">{{ setting('email', 'info@oriental-eg.com', 'string', 'contact', '*') }}</a>
              </div>
            </li>
            <li class="flex flex-row items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-geo-alt-fill mc-fill" viewBox="0 0 16 16">
                <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
              </svg>
              <div>
                <a href="#" class="font-semibold text-lg text-white">{{ setting('address', 'Egypt, Cairo', 'string', 'contact', '*') }}</a>
              </div>
            </li>
          </ul>
        </div>
            ...
            <div class="flex flex-row mt-9 text-white text-sm justify-between">
              ...
              <div>
                <a href="{{ setting('messenger', 'https://fb.com', 'string', 'contact', '*') }}">
                  <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-chat-left-dots mc-fill" viewBox="0 0 16 16">
