        ...
        <div class="">
          ...
          <ul class="list-none m-0 px-9 flex gap-4 flex-col justify-center w-80 mx-auto">
            <li class="flex flex-row items-center gap-2">
              ...
              <div>
                <a href="tel:{{ setting('phone_1', '+201000000', 'string', 'contact', '*') }}" class="font-semibold text-xl">{{ setting('phone_1', '+201000000', 'string', 'contact', '*') }}</a>
                <a href="tel:{{ setting('phone_2', '+201000000', 'string', 'contact', '*') }}" class="font-semibold text-xl">{{ setting('phone_2', '+201000000', 'string', 'contact', '*') }}</a>
              </div>
            </li>
            <li class="flex flex-row items-center gap-2">
              ...
              <div>
                <a target="_blank" href="https://wa.me/{{ setting('whatsapp', '201000000', 'string', 'contact', '*') }}" class="font-semibold text-xl">{{ setting('whatsapp', '+201000000', 'string', 'contact', '*') }}</a>
              </div>
            </li>
            <li class="flex flex-row items-center gap-2">
